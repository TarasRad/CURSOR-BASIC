...
//         var t = {};
//         return (
//             ve.each(e.match(De) || [], function (e, n) {
//                 t[n] = !0;
//             }),
//             t
//         );
...
//             d = (ve.cssNumber[t] || ("px" !== c && +l)) && We.exec(ve.css(e, t));
//         if (d && d[3] !== c) {
//             (c = c || d[3]), (n = n || []), (d = +l || 1);
//             do {
...
//             (i = e[r]).style &&
//                 ((n = i.style.display),
//                 t ? ("none" === n && ((o[r] = Pe.get(i, "display") || null), o[r] || (i.style.display = "")), "" === i.style.display && Re(i) && (o[r] = g(i))) : "none" !== n && ((o[r] = "none"), Pe.set(i, "display", n)));
//         for (r = 0; r < s; r++) null != o[r] && (e[r].style.display = o[r]);
//         return e;
//     }
//     function m(e, t) {
//         var n;
//         return (n = void 0 !== e.getElementsByTagName ? e.getElementsByTagName(t || "*") : void 0 !== e.querySelectorAll ? e.querySelectorAll(t || "*") : []), void 0 === t || (t && o(e, t)) ? ve.merge([e], n) : n;
//     }
//     function w(e, t) {
...
//                 else if (Ge.test(r)) {
//                     for (s = s || u.appendChild(t.createElement("div")), a = (_e.exec(r) || ["", ""])[1].toLowerCase(), l = Ve[a] || Ve._default, s.innerHTML = l[1] + ve.htmlPrefilter(r) + l[2], d = l[0]; d--; ) s = s.lastChild;
//                     ve.merge(p, s.childNodes), ((s = u.firstChild).textContent = "");
//                 } else p.push(t.createTextNode(r));
//         for (u.textContent = "", f = 0; (r = p[f++]); )
//             if (i && ve.inArray(r, i) > -1) o && o.push(r);
//             else if (((c = ve.contains(r.ownerDocument, r)), (s = m(u.appendChild(r), "script")), c && w(s), n)) for (d = 0; (r = s[d++]); ) Ye.test(r.type || "") && n.push(r);
//         return u;
//     }
//     function x() {
//         return !0;
...
//             h = t[0],
//             v = ve.isFunction(h);
//         if (v || (p > 1 && "string" == typeof h && !fe.checkClone && nt.test(h)))
//             return e.each(function (n) {
//                 var r = e.eq(n);
//                 v && (t[0] = h.call(this, n, r.html())), D(r, t, i, o);
//             });
//         if (p && ((r = b(t, e[0].ownerDocument, !1, e, o)), (s = r.firstChild), 1 === r.childNodes.length && (r = s), s || o)) {
//             for (l = (a = ve.map(m(r, "script"), $)).length; u < p; u++) (c = r), u !== f && ((c = ve.clone(c, !0, !0)), l && ve.merge(a, m(c, "script"))), i.call(e[u], c, u);
//             if (l)
//                 for (d = a[a.length - 1].ownerDocument, ve.map(a, A), u = 0; u < l; u++)
...
//     }
//     function N(e, t, n) {
//         for (var i, o = t ? ve.filter(t, e) : e, r = 0; null != (i = o[r]); r++) n || 1 !== i.nodeType || ve.cleanData(m(i)), i.parentNode && (n && ve.contains(i.ownerDocument, i) && w(m(i, "script")), i.parentNode.removeChild(i));
//         return e;
//     }
//     function L(e, t, n) {
//         var i,
...
//         return (
//             (n = n || at(e)) &&
//                 ("" !== (s = n.getPropertyValue(t) || n[t]) || ve.contains(e.ownerDocument, e) || (s = ve.style(e, t)),
//                 !fe.pixelMarginRight() && st.test(s) && rt.test(t) && ((i = a.width), (o = a.minWidth), (r = a.maxWidth), (a.minWidth = a.maxWidth = a.width = s), (s = n.width), (a.width = i), (a.minWidth = o), (a.maxWidth = r))),
//             void 0 !== s ? s + "" : s
//         );
//     }
//     function H(e, t) {
...
//     function P(e) {
//         var t = ve.cssProps[e];
//         return t || (t = ve.cssProps[e] = O(e) || e), t;
//     }
//     function q(e, t, n) {
//         var i = We.exec(t);
...
//             "margin" === n && (s += ve.css(e, n + ze[r], !0, o)),
//                 i
//                     ? ("content" === n && (s -= ve.css(e, "padding" + ze[r], !0, o)), "margin" !== n && (s -= ve.css(e, "border" + ze[r] + "Width", !0, o)))
//                     : ((s += ve.css(e, "padding" + ze[r], !0, o)), "padding" !== n && (s += ve.css(e, "border" + ze[r] + "Width", !0, o)));
//         return s;
//     }
//     function F(e, t, n) {
//         var i,
...
//         return st.test(r)
//             ? r
//             : ((i = s && (fe.boxSizingReliable() || r === e.style[t])), "auto" === r && (r = e["offset" + t[0].toUpperCase() + t.slice(1)]), (r = parseFloat(r) || 0) + M(e, t, n || (s ? "border" : "content"), i, o) + "px");
//     }
//     function I(e, t, n, i, o) {
//         return new I.prototype.init(e, t, n, i, o);
//     }
//     function W() {
//         vt && (!1 === ne.hidden && e.requestAnimationFrame ? e.requestAnimationFrame(W) : e.setTimeout(W, ve.fx.interval), ve.fx.tick());
//     }
//     function z() {
//         return (
...
//             g = Pe.get(e, "fxshow");
//         n.queue ||
//             (null == (s = ve._queueHooks(e, "fx")).unqueued &&
//                 ((s.unqueued = 0),
//                 (a = s.empty.fire),
...
//                 "none" === (d = ve.css(e, "display")) && (c ? (d = c) : (y([e], !0), (c = e.style.display || c), (d = ve.css(e, "display")), y([e]))),
...
//             for (i in f)
//                 l ||
//                     (g ? "hidden" in g && (v = g.hidden) : (g = Pe.access(e, "fxshow", { display: c })),
//                     r && (g.hidden = !v),
//                     v && y([e], !0),
//                     p.done(function () {
//                         v || y([e]), Pe.remove(e, "fxshow");
...
//             l = function () {
//                 if (o) return !1;
//                 for (var t = ht || z(), n = Math.max(0, c.startTime + c.duration - t), i = 1 - (n / c.duration || 0), r = 0, s = c.tweens.length; r < s; r++) c.tweens[r].run(i);
...
//             }),
//             d = c.props;
//         for (X(d, c.opts.specialEasing); r < s; r++) if ((i = _.prefilters[r].call(c, e, d, c.opts))) return ve.isFunction(i.stop) && (ve._queueHooks(c.elem, c.opts.queue).stop = ve.proxy(i.stop, i)), i;
//         return (
//             ve.map(d, B, c),
//             ve.isFunction(c.opts.start) && c.opts.start.call(e, c),
//             c.progress(c.opts.progress).done(c.opts.done, c.opts.complete).fail(c.opts.fail).always(c.opts.always),
//             ve.fx.timer(ve.extend(l, { elem: e, anim: c, queue: c.opts.queue })),
//             c
//         );
//     }
//     function Y(e) {
...
//                             (i = e[t]),
//                             s !== i &&
//                                 (c && i && (ve.isPlainObject(i) || (o = Array.isArray(i)))
//                                     ? (o ? ((o = !1), (r = n && Array.isArray(n) ? n : [])) : (r = n && ve.isPlainObject(n) ? n : {}), (s[t] = ve.extend(c, r, i)))
//                                     : void 0 !== i && (s[t] = i));
//             return s;
//         }),
//         ve.extend({
...
//                 var n = t || [];
//                 return null != e && (i(Object(e)) ? ve.merge(n, "string" == typeof e ? [e] : e) : se.call(n, e)), n;
//             },
...
//                     s = 0,
//                     a = [];
//                 if (i(e)) for (o = e.length; s < o; s++) null != (r = t(e[s], s, n)) && a.push(r);
...
//             proxy: function (e, t) {
//                 var n, i, o;
//                 if (("string" == typeof t && ((n = e[t]), (t = e), (e = n)), ve.isFunction(e)))
//                     return (
...
//             if (!i && ((t ? t.ownerDocument || t : I) !== N && D(t), (t = t || N), H)) {
//                 if (11 !== h && (l = ve.exec(e)))
//                     if ((o = l[1])) {
//                         if (9 === h) {
...
//                     }
//                 if (b.qsa && !U[e + " "] && (!O || !O.test(e))) {
//                     if (1 !== h) (f = t), (p = e);
//                     else if ("object" !== t.nodeName.toLowerCase()) {
//                         for ((a = t.getAttribute("id")) ? (a = a.replace(we, be)) : t.setAttribute("id", (a = F)), r = (d = S(e)).length; r--; ) d[r] = "#" + a + " " + u(d[r]);
...
//                           for (; (t = t[i]); )
//                               if (1 === t.nodeType || s)
//                                   if (((u = t[F] || (t[F] = {})), (d = u[t.uniqueID] || (u[t.uniqueID] = {})), o && o === t.nodeName.toLowerCase())) t = t[i] || t;
//                                   else {
...
//                         if (r && d) {
//                             for (u = 0, s || d.ownerDocument === N || (D(d), (a = !H)); (p = e[u++]); )
//                                 if (p(d, s || N, a)) {
//                                     l.push(d);
//                                     break;
//                                 }
...
//             );
//         try {
//             Q.apply((Y = J.call(I.childNodes)), I.childNodes), Y[I.childNodes.length].nodeType;
//         } catch (e) {
//             Q = {
//                 apply: Y.length
//                     ? function (e, t) {
...
//                       (L = N.documentElement),
//                       (H = !k(N)),
//                       I !== N && (n = N.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener("unload", xe, !1) : n.attachEvent && n.attachEvent("onunload", xe)),
...
//                                   O.push(",.*:");
//                           })),
//                       (b.matchesSelector = he.test((q = L.matches || L.webkitMatchesSelector || L.mozMatchesSelector || L.oMatchesSelector || L.msMatchesSelector))) &&
//                           o(function (e) {
...
//                                         ? e === N || (e.ownerDocument === I && M(I, e))
//                                             ? -1
//                                             : t === N || (t.ownerDocument === I && M(I, t))
//                                             ? 1
//                                             : E
//                                             ? K(E, e) - K(E, t)
//                                             : 0
...
//                 if (((e.ownerDocument || e) !== N && D(e), (n = n.replace(le, "='$1']")), b.matchesSelector && H && !U[n + " "] && (!P || !P.test(n)) && (!O || !O.test(n))))
//                     try {
//                         var i = q.call(e, n);
...
//                     i = n && _.call(x.attrHandle, t.toLowerCase()) ? n(e, t, !H) : void 0;
...
//                     i = 0,
//                     o = 0;
//                 if (((j = !b.detectDuplicates), (E = !b.sortStable && e.slice(0)), e.sort(X), j)) {
...
//                                           for (
//                                               w = (f = (c = (d = (u = (p = g)[F] || (p[F] = {}))[p.uniqueID] || (u[p.uniqueID] = {}))[e] || [])[0] === W && c[1]) && c[2], p = f && g.childNodes[f];
...
//                                                   break;
//                                               }
//                                       } else if ((m && ((p = t), (u = p[F] || (p[F] = {})), (d = u[p.uniqueID] || (u[p.uniqueID] = {})), (c = d[e] || []), (f = c[0] === W && c[1]), (w = f)), !1 === w))
//                                           for (
//                                               ;
//                                               (p = (++f && p && p[v]) || (w = f = 0) || h.pop()) &&
//                                               ((a ? p.nodeName.toLowerCase() !== y : 1 !== p.nodeType) || !++w || (m && ((u = p[F] || (p[F] = {})), (d = u[p.uniqueID] || (u[p.uniqueID] = {})), (d[e] = [W, w])), p !== t));
...
//                     r = U[e + " "];
//                 if (!r) {
//                     for (t || (t = S(e)), n = t.length; n--; ) (r = y(t[n])), r[F] ? i.push(r) : o.push(r);
//                     (r = U(e, m(o, i))).selector = e;
//                 }
//                 return r;
//             }),
...
//                         if ((l = x.find[a]) && (i = l(s.matches[0].replace(ye, me), (ge.test(r[0].type) && c(t.parentNode)) || t))) {
...
//             }),
//             (b.sortStable = F.split("").sort(X).join("") === F),
...
//             if (i[1]) {
//                 if (((t = t instanceof ve ? t[0] : t), ve.merge(this, ve.parseHTML(i[1], t && t.nodeType ? t.ownerDocument || t : ne, !0)), Se.test(i[1]) && ve.isPlainObject(t)))
...
//                     return "Until" !== e.slice(-5) && (i = n), i && "string" == typeof i && (o = ve.filter(i, o)), this.length > 1 && (je[e] || ve.uniqueSort(o), Ee.test(e) && o.reverse()), this.pushStack(o);
//                 };
//             }
//         );
//     var De = /[^\x20\t\r\n\f]+/g;
...
//                             for (var n; (n = ve.inArray(t, r, n)) > -1; ) r.splice(n, 1), n <= l && l--;
//                         }),
//                         this
//                     );
//                 },
...
//                                             e && ve.isFunction(e.promise) ? e.promise().progress(t.notify).done(t.resolve).fail(t.reject) : t[i[0] + "With"](this, o ? [e] : arguments);
//                                         });
//                                     }),
//                                         (e = null);
//                                 })
...
//                                                             : (s++, u.call(e, r(s, n, l, o), r(s, n, c, o), r(s, n, l, n.notifyWith)))
//                                                         : (i !== l && ((a = void 0), (d = [e])), (o || n.resolveWith)(a, d));
//                                             }
//                                         },
//                                         p = o
//                                             ? u
...
//                         };
//                     };
//                 if (t <= 1 && (d(e, r.done(s(n)).resolve, r.reject, !t), "pending" === r.state() || ve.isFunction(o[n] && o[n].then))) return r.then();
...
//             readyWait: 1,
//             ready: function (e) {
//                 (!0 === e ? --ve.readyWait : ve.isReady) || ((ve.isReady = !0), (!0 !== e && --ve.readyWait > 0) || Le.resolveWith(ne, [ve]));
//             },
//         }),
//         (ve.ready.then = Le.then),
//         "complete" === ne.readyState || ("loading" !== ne.readyState && !ne.documentElement.doScroll) ? e.setTimeout(ve.ready) : (ne.addEventListener("DOMContentLoaded", u), e.addEventListener("load", u));
...
//                 if (void 0 !== i) {
//                     if (void 0 !== t) {
//                         Array.isArray(t) ? (t = t.map(ve.camelCase)) : ((t = ve.camelCase(t)), (t = t in i ? [t] : t.match(De) || [])), (n = t.length);
//                         for (; n--; ) delete i[t[n]];
//                     }
...
//                         for (n = s.length; n--; ) s[n] && 0 === (i = s[n].name).indexOf("data-") && ((i = ve.camelCase(i.slice(5))), h(r, i, o[i]));
...
//                 var i;
//                 if (e) return (t = (t || "fx") + "queue"), (i = Pe.get(e, t)), n && (!i || Array.isArray(n) ? (i = Pe.access(e, t, ve.makeArray(n))) : i.push(n)), i || [];
//             },
...
//                         --i || o.resolveWith(r, [r]);
//                     };
//                 for ("string" != typeof e && ((t = e), (e = void 0)), e = e || "fx"; s--; ) (n = Pe.get(r[s], e + "queueHooks")) && n.empty && (i++, n.empty.add(a));
...
//     var Ge = /<|&#?\w+;/;
//     !(function () {
//         var e = ne.createDocumentFragment().appendChild(ne.createElement("div")),
...
//                         (h = (a[2] || "").split(".").sort()),
//                         f &&
//                             ((u = ve.event.special[f] || {}),
//                             (f = (o ? u.delegateType : u.bindType) || f),
//                             (u = ve.event.special[f] || {}),
//                             (d = ve.extend({ type: f, origType: v, data: i, handler: n, guid: n.guid, selector: o, needsContext: o && ve.expr.match.needsContext.test(o), namespace: h.join(".") }, r)),
...
//                 h,
//                 v,
//                 g = Pe.hasData(e) && Pe.get(e);
//             if (g && (l = g.events)) {
//                 for (c = (t = (t || "").match(De) || [""]).length; c--; )
//                     if (((a = Ze.exec(t[c]) || []), (f = v = a[1]), (h = (a[2] || "").split(".").sort()), f)) {
//                         for (u = ve.event.special[f] || {}, p = l[(f = (i ? u.delegateType : u.bindType) || f)] || [], a = a[2] && new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)"), s = r = p.length; r--; )
//                             (d = p[r]),
//                                 (!o && v !== d.origType) ||
//                                     (n && n.guid !== d.guid) ||
...
//                     } else for (f in l) ve.event.remove(e, f + t[c], n, i, !0);
...
//                             ((a.handleObj = r), (a.data = r.data), void 0 !== (i = ((ve.event.special[r.origType] || {}).handle || r.handler).apply(o.elem, l)) && !1 === (a.result = i) && (a.preventDefault(), a.stopPropagation()));
...
//                         for (r = [], s = {}, n = 0; n < l; n++) (i = t[n]), (o = i.selector + " "), void 0 === s[o] && (s[o] = i.needsContext ? ve(o, this).index(c) > -1 : ve.find(o, this, null, [c]).length), s[o] && r.push(i);
...
//             ve.event.addProp
//         ),
//         ve.each({ mouseenter: "mouseover", mouseleave: "mouseout", pointerenter: "pointerover", pointerleave: "pointerout" }, function (e, t) {
//             ve.event.special[e] = {
//                 delegateType: t,
//                 bindType: t,
//                 handle: function (e) {
...
//             if (!(fe.noCloneChecked || (1 !== e.nodeType && 11 !== e.nodeType) || ve.isXMLDoc(e))) for (s = m(a), r = m(e), i = 0, o = r.length; i < o; i++) j(r[i], s[i]);
//             if (t)
//                 if (n) for (r = r || m(e), s = s || m(a), i = 0, o = r.length; i < o; i++) E(r[i], s[i]);
//                 else E(e, a);
...
//                         if ("string" == typeof e && !tt.test(e) && !Ve[(_e.exec(e) || ["", ""])[1].toLowerCase()]) {
//                             e = ve.htmlPrefilter(e);
//                             try {
//                                 for (; n < i; n++) 1 === (t = this[n] || {}).nodeType && (ve.cleanData(m(t, !1)), (t.innerHTML = e));
//                                 t = 0;
//                             } catch (e) {}
//                         }
...
//             ve.fn[e] = function (e) {
//                 for (var n, i = [], o = ve(e), r = o.length - 1, s = 0; s <= r; s++) (n = s === r ? this : this.clone(!0)), ve(o[s])[t](n), se.apply(i, n.get());
...
//                             ? o
//                             : c[t]
//                         : ("string" === (r = typeof n) && (o = We.exec(n)) && o[1] && ((n = v(e, t, o)), (r = "number")),
//                           void (
//                               null != n &&
//                               n === n &&
//                               ("number" === r && (n += (o && o[3]) || (ve.cssNumber[a] ? "" : "px")),
...
//             return (
//                 ct.test(t) || (t = P(a)),
//                 (s = ve.cssHooks[t] || ve.cssHooks[a]) && "get" in s && (o = s.get(e, !0, n)),
//                 void 0 === o && (o = L(e, t, i)),
...
//                 get: function (e, n, i) {
//                     if (n)
//                         return !lt.test(ve.css(e, "display")) || (e.getClientRects().length && e.getBoundingClientRect().width)
//                             ? F(e, t, i)
//                             : Be(e, dt, function () {
//                                   return F(e, t, i);
//                               });
...
//                     var o,
//                         r = i && at(e),
//                         s = i && M(e, t, i, "border-box" === ve.css(e, "boxSizing", !1, r), r);
//                     return s && (o = We.exec(n)) && "px" !== (o[3] || "px") && ((e.style[t] = n), (n = ve.css(e, t))), q(e, n, s);
//                 },
//             };
//         }),
...
//                             s = 0;
//                         if (Array.isArray(t)) {
//                             for (i = at(e), o = t.length; s < o; s++) r[t[s]] = ve.css(e, t[s], !1, i);
//                             return r;
//                         }
...
//                 return (
//                     this.options.duration ? (this.pos = t = ve.easing[this.easing](e, this.options.duration * e, 0, 1, this.options.duration)) : (this.pos = t = e),
...
//             _default: "swing",
//         }),
//         (ve.fx = I.prototype.init),
//         (ve.fx.step = {});
//     var ht,
//         vt,
//         gt = /^(?:toggle|show|hide)$/,
//         yt = /queueHooks$/;
//     (ve.Animation = ve.extend(_, {
//         tweeners: {
//             "*": [
//                 function (e, t) {
...
//             var i = e && "object" == typeof e ? ve.extend({}, e) : { complete: n || (!n && t) || (ve.isFunction(e) && e), duration: e, easing: (n && t) || (t && !ve.isFunction(t) && t) };
//             return (
//                 ve.fx.off ? (i.duration = 0) : "number" != typeof i.duration && (i.duration in ve.fx.speeds ? (i.duration = ve.fx.speeds[i.duration]) : (i.duration = ve.fx.speeds._default)),
...
//                 t = ne.createElement("select").appendChild(ne.createElement("option"));
...
//                         ? ve.prop(e, t, n)
//                         : ((1 === r && ve.isXMLDoc(e)) || (o = ve.attrHooks[t.toLowerCase()] || (ve.expr.match.bool.test(t) ? mt : void 0)),
//                           void 0 !== n
//                               ? null === n
...
//                 if (3 !== r && 8 !== r && 2 !== r)
//                     return (
//                         (1 === r && ve.isXMLDoc(e)) || ((t = ve.propFix[t] || t), (o = ve.propHooks[t])),
...
//                     : this.each(function () {
//                           var t, i, o, r;
//                           if ("string" === n) for (i = 0, o = ve(this), r = e.match(De) || []; (t = r[i++]); ) o.hasClass(t) ? o.removeClass(t) : o.addClass(t);
//                           else (void 0 !== e && "boolean" !== n) || ((t = V(this)) && Pe.set(this, "__className__", t), this.setAttribute && this.setAttribute("class", t || !1 === e ? "" : Pe.get(this, "__className__") || ""));
//                       });
//             },
//             hasClass: function (e) {
//                 var t,
//                     n,
//                     i = 0;
//                 for (t = " " + e + " "; (n = this[i++]); ) if (1 === n.nodeType && (" " + Y(V(n)) + " ").indexOf(t) > -1) return !0;
//                 return !1;
//             },
//         });
//     var Tt = /\r/g;
...
//                   }))
//                 : o
//                 ? ((t = ve.valHooks[o.type] || ve.valHooks[o.nodeName.toLowerCase()]), t && "get" in t && void 0 !== (n = t.get(o, "value")) ? n : ((n = o.value), "string" == typeof n ? n.replace(Tt, "") : null == n ? "" : n))
//                 : void 0;
//         },
//     }),
//         ve.extend({
...
//                 3 !== i.nodeType &&
//                     8 !== i.nodeType &&
//                     !kt.test(f + ve.event.triggered) &&
//                     (f.indexOf(".") > -1 && ((h = f.split(".")), (f = h.shift()), h.sort()),
//                     (c = f.indexOf(":") < 0 && "on" + f),
//                     (t = t[ve.expando] ? t : new ve.Event(f, "object" == typeof t && t)),
//                     (t.isTrigger = o ? 2 : 3),
//                     (t.namespace = h.join(".")),
...
//                         (d = (Pe.get(s, "events") || {})[t.type] && Pe.get(s, "handle")) && d.apply(s, n),
//                         (d = c && s[c]) && d.apply && Oe(s) && ((t.result = d.apply(s, n)), !1 === t.result && t.preventDefault());
//                 return (
//                     (t.type = f),
//                     o ||
...
//                         !Oe(i) ||
//                         (c && ve.isFunction(i[f]) && !ve.isWindow(i) && ((a = i[c]) && (i[c] = null), (ve.event.triggered = f), i[f](), (ve.event.triggered = void 0), a && (i[c] = a))),
//                     t.result
//                 );
//             }
//         },
...
//                     .filter(function () {
//                         var e = this.type;
//                         return this.name && !ve(this).is(":disabled") && Dt.test(this.nodeName) && !jt.test(e) && (this.checked || !Xe.test(e));
//                     })
//                     .map(function (e, t) {
//                         var n = ve(this).val();
//                         return null == n
...
//                         (b = ee(h, b, k, c)),
//                         c
//                             ? (h.ifModified && ((x = k.getResponseHeader("Last-Modified")) && (ve.lastModified[r] = x), (x = k.getResponseHeader("etag")) && (ve.etag[r] = x)),
...
//                         m.fireWith(v, [k, T]),
//                         u && (g.trigger("ajaxComplete", [k, h]), --ve.active || ve.event.trigger("ajaxStop")));
//                 }
...
//                     }
//                 }
//                 if ((h.data && h.processData && "string" != typeof h.data && (h.data = ve.param(h.data, h.traditional)), J(Ft, h, n, k), d)) return k;
//                 (u = ve.event && h.global) && 0 == ve.active++ && ve.event.trigger("ajaxStart"),
...
//                         : ((f = h.url.slice(r.length)), h.data && ((r += ($t.test(r) ? "&" : "?") + h.data), delete h.data), !1 === h.cache && ((r = r.replace(Ht, "$1")), (f = ($t.test(r) ? "&" : "?") + "_=" + Ct++ + f)), (h.url = r + f)),
//                     h.ifModified && (ve.lastModified[r] && k.setRequestHeader("If-Modified-Since", ve.lastModified[r]), ve.etag[r] && k.setRequestHeader("If-None-Match", ve.etag[r])),
//                     ((h.data && h.hasContent && !1 !== h.contentType) || n.contentType) && k.setRequestHeader("Content-Type", h.contentType),
//                     k.setRequestHeader("Accept", h.dataTypes[0] && h.accepts[h.dataTypes[0]] ? h.accepts[h.dataTypes[0]] + ("*" !== h.dataTypes[0] ? ", " + Wt + "; q=0.01" : "") : h.accepts["*"]);
//                 for (p in h.headers) k.setRequestHeader(p, h.headers[p]);
//                 if (h.beforeSend && (!1 === h.beforeSend.call(v, k, h) || d)) return k.abort();
//                 if (((T = "abort"), m.add(h.complete), k.done(h.success), k.fail(h.error), (o = J(It, h, n, k)))) {
...
//                                         : r(Rt[a.status] || a.status, a.statusText, "text" !== (a.responseType || "text") || "string" != typeof a.responseText ? { binary: a.response } : { text: a.responseText }, a.getAllResponseHeaders()));
//                             };
//                         }),
//                             (a.onload = n()),
//                             (i = a.onerror = n("error")),
...
//                 return (
//                     (o = t.jsonpCallback = ve.isFunction(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback),
//                     a ? (t[a] = t[a].replace(Xt, "$1" + o)) : !1 !== t.jsonp && (t.url += ($t.test(t.url) ? "&" : "?") + t.jsonp + "=" + o),
...
//             var i, o, r;
//             return (
//                 t || (fe.createHTMLDocument ? ((t = ne.implementation.createHTMLDocument("")), (i = t.createElement("base")), (i.href = ne.location.href), t.head.appendChild(i)) : (t = ne)),
//                 (o = Se.exec(e)),
//                 (r = !n && []),
//                 o ? [t.createElement(o[1])] : ((o = b([e], t, r)), r && r.length && ve(r).remove(), ve.merge([], o.childNodes))
//             );
//         }),
...
//                 ve.isFunction(t) ? ((n = t), (t = void 0)) : t && "object" == typeof t && (o = "POST"),
//                 s.length > 0 &&
//                     ve
...
//                     (r = ve.css(e, "top")),
//                     (l = ve.css(e, "left")),
//                     ("absolute" === c || "fixed" === c) && (r + l).indexOf("auto") > -1 ? ((i = d.position()), (s = i.top), (o = i.left)) : ((s = parseFloat(r) || 0), (o = parseFloat(l) || 0)),
...
//                         ? ((i = r.getBoundingClientRect()), (t = r.ownerDocument), (n = t.documentElement), (o = t.defaultView), { top: i.top + o.pageYOffset - n.clientTop, left: i.left + o.pageXOffset - n.clientLeft })
//                         : { top: 0, left: 0 }
//                     : void 0;
//             },
//             position: function () {
...
//                             : ((e = this.offsetParent()), (t = this.offset()), o(e[0], "html") || (i = e.offset()), (i = { top: i.top + ve.css(e[0], "borderTopWidth", !0), left: i.left + ve.css(e[0], "borderLeftWidth", !0) })),
//                         { top: t.top - i.top - ve.css(n, "marginTop", !0), left: t.left - i.left - ve.css(n, "marginLeft", !0) }
//                     );
//                 }
//             },
...
//                     function (e, i, o) {
//                         var r;
//                         return ve.isWindow(e) ? (r = e) : 9 === e.nodeType && (r = e.defaultView), void 0 === o ? (r ? r[t] : e[i]) : void (r ? r.scrollTo(n ? r.pageXOffset : o, n ? o : r.pageYOffset) : (e[i] = o));
//                     },
//                     e,
//                     i,
//                     arguments.length
...
//             ve.cssHooks[t] = H(fe.pixelPosition, function (e, n) {
//                 if (n) return (n = L(e, t)), st.test(n) ? ve(e).position()[t] + "px" : n;
//             });
//         }),
...
//                         ? ((i = r.currentSlide + (r.options.slidesToShow / 2 + 1)), (o = i + r.options.slidesToShow + 2))
...
//                           !1 === c.options.infinite && !1 === c.options.centerMode && (0 > e || e > c.getDotCount() * c.options.slidesToScroll)
//                               ? void (
//                                     !1 === c.options.fade &&
//                                     ((i = c.currentSlide),
//                                     !0 !== n
...
//                                         : c.postSlide(i))
//                                 )
//                               : !1 === c.options.infinite && !0 === c.options.centerMode && (0 > e || e > c.slideCount - c.options.slidesToScroll)
//                               ? void (
//                                     !1 === c.options.fade &&
//                                     ((i = c.currentSlide),
//                                     !0 !== n
